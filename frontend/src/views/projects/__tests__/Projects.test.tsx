...
// Mock the Projects component to avoid complex dependencies
vi.mock('../../projects', () => ({
  Projects: () => <div data-testid="projects-view">Projects View</div>,
}));

// Import after mocking
const { Projects } = await import('../../projects');

describe('Projects View Integration Tests (DataFacet refactor preparation)', () => {
