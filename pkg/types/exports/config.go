...
func getAssetsFields() []types.FieldConfig {
	ret := []types.FieldConfig{
		...
		{Section: "Asset", Key: "spotPrice", Type: "float"},
		...
		{Section: "Summary", Key: "gasUsed", Type: "value", NoTable: true},
...
func getBalancesFields() []types.FieldConfig {
	ret := []types.FieldConfig{
		{Section: "Balance Info", Key: "date", Type: "datetime"},
...
func getStatementsFields() []types.FieldConfig {
	ret := []types.FieldConfig{
		...
		{Section: "Reconciliation", Key: "calcs.amountNetEth", Type: "ether", NoTable: true},
		{Section: "Reconciliation", Key: "calcs.endBalEth", Type: "ether"},
		{Section: "Asset", Key: "spotPrice", Type: "float", NoTable: true},
		{Section: "Reconciliation", Key: "calcs.endBalCalcEth", Type: "ether", NoTable: true},
		{Section: "Summary", Key: "date", Type: "datetime", NoTable: true},
		{Section: "Summary", Key: "gasUsed", Type: "value", NoTable: true},
		{Section: "Summary", Key: "calcs.reconciliationType", NoTable: true},
...
func getTransfersFields() []types.FieldConfig {
	ret := []types.FieldConfig{
		...
		{Section: "Breakdown", Key: "amount", Type: "int256"},
		{Section: "Details", Key: "sender", Type: "address", NoTable: true},
		{Section: "Details", Key: "recipient", Type: "address", NoTable: true},
		{Section: "Details", Key: "holder", Type: "address", NoTable: true},
		{Section: "Details", Key: "decimals", Type: "uint64", NoTable: true},
		{Section: "Breakdown", Key: "amountIn", Type: "int256", NoTable: true},
		{Section: "Breakdown", Key: "amountOut", Type: "int256", NoTable: true},
		{Section: "Breakdown", Key: "internalIn", Type: "int256", NoTable: true},
		{Section: "Breakdown", Key: "internalOut", Type: "int256", NoTable: true},
		{Section: "Breakdown", Key: "gasOut", Type: "int256", NoTable: true},
		{Section: "Mining", Key: "minerBaseRewardIn", Type: "int256", NoTable: true},
		{Section: "Mining", Key: "minerNephewRewardIn", Type: "int256", NoTable: true},
		{Section: "Mining", Key: "minerTxFeeIn", Type: "int256", NoTable: true},
		{Section: "Mining", Key: "minerUncleRewardIn", Type: "int256", NoTable: true},
		{Section: "Special", Key: "selfDestructIn", Type: "int256", NoTable: true},
		{Section: "Special", Key: "selfDestructOut", Type: "int256", NoTable: true},
		{Section: "Special", Key: "prefundIn", Type: "int256", NoTable: true},
		{Section: "", Key: "actions", Type: "actions", NoDetail: true},
	}
	types.NormalizeFields(&ret)
	return ret
...
func getWithdrawalsFields() []types.FieldConfig {
	ret := []types.FieldConfig{
		...
		{Section: "Details", Key: "index", Type: "value"},
		{Section: "Details", Key: "validatorIndex", Type: "value"},
